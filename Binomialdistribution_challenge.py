...
class Binomial(Distribution):
    ...
    def calculate_stdev(self):
        st_dev = math.sqrt(self.n * self.p * (1 - self.p))
        self.sigma = st_dev
        return self.sigma
    ...
    def histogram_pdf(self):
        ...
        ax.bar(k_list,pdf_list)
        ax.set_xlabel('k')
        ax.set_y_label('pdf')
        plt.show()                                                                                                                           #return k_list,pdf_list         
    ...
    def __add__(self,other):
        ...
        result.mu = result.calculate_mean()
        result.sigma = result.calculate_stdev()
        return result
    ...
    def __repr__():
        return 'mean {}, standard deviation {}, p {}, n {}'.format(self.mu,self.sigma,self.p,self.n)
